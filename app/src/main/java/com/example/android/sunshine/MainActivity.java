...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewWeatherData = findViewById(R.id.tv_weather_data);
        ...
        String[] weatherData = {"12 Deg, Sunny","23 Deg, Windy","19 Deg, Heavy rain","12 Deg, Sunny",
                "Windy","23 Deg, Windy","19 Deg, Heavy rain","12 Deg, Sunny"};
        ...
        {
            textViewWeatherData.append(weatherItem + "\n\n\n");
        }
    }
}